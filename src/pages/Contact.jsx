      ...
      <div className="backdrop-blur-md bg-white/10 border border-white/20 rounded-2xl shadow-2xl p-10 w-full max-w-5xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="text-white space-y-6">
            ...
            <div>
              <p><strong>📍 Endereço:</strong> Rua das Amizades, 123, Brasília - DF</p>
              <p><strong>📧 Email:</strong> lucasbritocientista@gmail.com</p>
              <p><strong>📞 Telefone:</strong> +55 61 98404-2710</p>
            </div>
          </div>
